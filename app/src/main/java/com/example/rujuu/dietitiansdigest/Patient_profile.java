...
public class Patient_profile extends AppCompatActivity {
    ...
    private class CallUrl extends AsyncTask<Void,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(s.equals("error"))
            {
                ...
                Toast.makeText(Patient_profile.this,"Please try again.",Toast.LENGTH_SHORT).show();
            }
            else
            {
                names.clear();
                ...
                listView.setAdapter( new ArrayAdapter<String>(Patient_profile.this,android.R.layout.simple_list_item_1,names));
    ...
    public void sendemail(String to)
    {
        ...
        try {
            ...
            Toast.makeText(Patient_profile.this,
